      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="border border-telemetry-primary/30 bg-telemetry-primary/5 rounded-lg p-8">
              <h3 className="text-2xl font-semibold text-txt-primary mb-4 text-center">
                Leadership
              </h3>
