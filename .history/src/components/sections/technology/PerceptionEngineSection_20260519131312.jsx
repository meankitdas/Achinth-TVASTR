      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border-subtle border border-border-subtle mt-12">
        {stages.map((stage, i) => (
          <div
            key={i}
            data-reveal-item
            className={`p-7 bg-bg-primary ${
              i === stages.length - 1 ? "md:col-span-2 lg:col-span-2" : ""
            }`}
          >
            <div className={i === stages.length - 1 ? "max-w-[380px]" : ""}>
              <p
              ...
              <div className="px-3 py-2 bg-bg-panel border border-border-subtle rounded text-[12px] text-txt-secondary">
