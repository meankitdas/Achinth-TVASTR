    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-12 lg:px-16 text-center">
          ...
          <span className="relative flex h-1.5 w-1.5" aria-hidden="true">
            {!reducedMotion && (
              <span
                ...
                style={{ background: "var(--signal-glow)", opacity: 0.7 }}
              />
            )}
            <span
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
          ...
          <Link
            to="/technology"
            className="inline-flex items-center gap-2 text-sm text-signal-glow border-b border-signal-glow/40 pb-0.5 hover:border-signal-glow transition-colors focus:outline-none focus-visible:border-signal-glow focus-visible:text-signal-glow"
          >
        ...
        >
          ...
          <span
            ...
            style={{ background: "rgba(255,119,89,0.22)" }}
          >
            {!reducedMotion && (
              <span
      ...
      <div
        ...
        style={{
          background: "var(--process-primary)",
          borderTop: "2px solid var(--signal-glow)",
        }}
      >
