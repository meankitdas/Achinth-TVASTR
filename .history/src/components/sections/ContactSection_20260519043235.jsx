            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg text-txt-primary placeholder:text-txt-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-process-primary"
                  style={{
                    background: "var(--bg-primary)",
                    border: "1px solid var(--border-default)",
                  }}
