  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-12 lg:px-16 text-center">
        ...
        {/* Hairline divider — replaces the white capability cards. The
            three capability anchors live in the full-bleed system rail
            below, where they read as a control-room telemetry strip
            instead of floating white cards punching through the video. */}
        <div ref={stripRef} className="mt-16 md:mt-20 mx-auto max-w-2xl">
          <div className="flex items-center justify-center gap-3 font-mono text-[10px] tracking-[0.28em] uppercase text-txt-muted">
