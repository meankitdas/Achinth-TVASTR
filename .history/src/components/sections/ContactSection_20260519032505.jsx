          ...
          <div className="space-y-4">
            <p className="text-sm text-txt-secondary">
              ...
              <a
                ...
                className="text-txt-secondary no-underline focus:outline-none focus-visible:underline focus-visible:decoration-telemetry-primary focus-visible:decoration-2 focus-visible:underline-offset-4"
              >
                achintharya@tvastr.co
              </a>
            </p>
            <p className="text-sm text-txt-secondary">
              <span className="font-semibold text-txt-primary">LinkedIn:</span>{" "}
              <a
