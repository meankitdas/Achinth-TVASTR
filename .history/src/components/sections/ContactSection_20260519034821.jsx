            ...
            <div>
              ...
              <dd>
                <a
                  ...
                  className="text-base text-txt-primary border-b border-txt-primary/30 hover:border-txt-primary pb-0.5 transition-colors focus:outline-none focus-visible:border-telemetry-primary focus-visible:text-telemetry-primary"
                >
