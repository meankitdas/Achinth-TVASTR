    ...
    <SectionShell ref={sectionRef} id={id}>
      ...
      <div className="grid lg:grid-cols-2 gap-8 mb-16">
        {systems.map((system, idx) => (
          ...
          >
            <p className="font-mono text-[11px] tracking-[0.24em] uppercase text-txt-muted mb-4">
              System {String(idx + 1).padStart(2, "0")} — {system.tagline}
            </p>
            ...
            <Link
              to={system.route}
              className="inline-flex items-center gap-2 self-start px-5 py-2.5 rounded-full text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-telemetry-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-panel"
              style={{
