  ...
  return (
    ...
    >
      ...
      {/* Full-bleed system rail — three-column control-room telemetry
          band on the brand coral. Each capability gets its own column
          with a large mono index numeral, a label, and a value,
          separated by thin warm-on-warm vertical dividers. The coral
          rail anchors the bottom of the hero with a single confident
          orange moment, balancing the green CTAs above. */}
      <div
            ...
            {stripItems.map((item, i) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-mono text-[10px] md:text-[11px] tracking-[0.28em] uppercase leading-tight">
                    {item.label}
                  </p>
                  <p
                    className="text-[12px] md:text-[13px] leading-snug mt-1.5 truncate"
      ...
      {/* The full-bleed coral system rail above provides the section's
