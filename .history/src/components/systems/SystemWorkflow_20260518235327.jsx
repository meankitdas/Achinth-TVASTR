    ...
    <div className="mt-6 mb-2">
      ...
      <div className="flex flex-wrap items-center gap-y-4">
        ...
        {outputs && outputs.length > 0 && (
          <>
            <svg className="mx-2 flex-shrink-0" width="24" height="16" viewBox="0 0 24 16" fill="none">
              <path d="M0 8h20M16 4l4 4-4 4" stroke="#94a3b8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <div
              className="px-4 py-3"
              style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '6px' }}
            >
              <p className="text-xs font-semibold text-green-700 mb-2 tracking-wide uppercase">Output</p>
