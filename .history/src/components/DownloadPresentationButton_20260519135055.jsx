  ...
  return (
    <>
      ...
      <section
        ...
        style={{ background: "var(--bg-primary)", textAlign: "center" }}
      >
        <div
          style={{ maxWidth: "480px", margin: "0 auto", textAlign: "center" }}
        >
          <p
            className="font-mono text-[11px] tracking-[0.28em] uppercase mb-8"
            style={{ color: "var(--signal-glow)" }}
          >
            Contact
          </p>
          <p className="text-2xl md:text-3xl font-medium text-txt-primary mb-3">
            {contactName}
          </p>
          <a
            href={`mailto:${contactEmail}`}
            className="text-base text-txt-secondary hover:text-process-primary transition-colors"
          ...
          >
            <p className="font-mono text-[10px] tracking-[0.28em] uppercase text-txt-muted">
