export const energyReasoningContent = {
  ...
  subtitle: "Adaptive confidence evolution through signal force balancing and stability validation.",
  ...
  concepts: [
    {
      name: "Signal Forces",
      description: "Each signal source (topology, anomaly, SCRATA standards, neural classification) contributes an additive force that pushes the decision toward accept or reject."
    },
    {
      name: "Confidence Evolution",
      description: "The decision score evolves iteratively as signal forces are applied. The system does not produce a static one-shot confidence — it reaches convergence through multi-step reasoning."
    },
    {
      name: "Stability Validation",
      description: "Before committing a final decision, the system validates that the confidence has stabilized within tolerance bounds. Unstable states trigger rollback and human review."
    },
    {
      name: "Disagreement Handling",
      description: "When signal forces push in opposing directions beyond stability thresholds, the system identifies the disagreement explicitly and routes to manual review with full signal evidence."
    },
    {
      name: "Adaptive Thresholds",
      description: "Decision boundaries adapt based on signal quality and confidence evolution — higher-quality signals produce tighter convergence, while degraded inputs widen review bands."
    }
  ],
  decisionTiers: [
