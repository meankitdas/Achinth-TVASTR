export const energyReasoningContent = {
  ...
  concepts: [
    ...
    },
    {
      ...
      description:
        "Decision boundaries adapt based on signal quality and confidence evolution — higher-quality signals produce tighter convergence, while degraded inputs widen review bands. The system recalibrates acceptance and rejection thresholds based on per-signal noise levels and sensor health status, ensuring decision precision scales with the reliability of available evidence.",
    },
  ],
  decisionTiers: [
    {
