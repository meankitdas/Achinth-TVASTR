...
export function ResearchPage() {
  ...
  const publications = [
    ...
    },
    {
      ...
      year: "2026",
      abstract:
        "We present a physics-inspired classification system that models defect detection as an energy minimization problem using Lyapunov stability functions. The system combines topology reasoning (spatial defect coherence) with energy-based force application to achieve guaranteed convergence and 35% higher accuracy than threshold-based approaches.",
      topics: [
        "Energy Optimization",
        "Lyapunov Stability",
        "Topology Reasoning",
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {researchAreas.map((area, idx) => (
              ...
              >
                ...
                <p className="text-txt-secondary mb-6">{area.description}</p>
                <ul className="space-y-3">
                  {area.topics.map((topic, tidx) => (
                    <li
                      key={tidx}
                      className="text-txt-secondary flex items-start gap-2"
                    >
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            {publications.map((pub, idx) => (
              ...
              >
                ...
                <p className="text-txt-secondary mb-4">{pub.abstract}</p>
